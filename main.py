...
async def main():
    ...
    bot = Client("8009904311:AAHal98ZGIf_bVc5jusYx9Y0pbNdozO25Sk",
                 api_id="27649783",
                 api_hash="834fd6015b50b781e0f8a41876ca95c8",
                 bot_token="8009904311:AAHal98ZGIf_bVc5jusYx9Y0pbNdozO25Sk",
                 plugins=plugins)
    clients = [user, bot]
...
"""
                                    ...
                                    if e == first_error:
                                        resp = "No CC Found"
                                        await bot.delete_messages(message.chat.id, delete.id)
                                        await message.reply_text(text=resp, reply_to_message_id=message.id)
                                    elif e == sec_error:
                                        resp = "𝗪𝗿𝗼𝗻𝗴 𝗨𝘀𝗲𝗿𝗻𝗮𝗺𝗲 ❌"
                                        await bot.delete_messages(message.chat.id, delete.id)
                                        await message.reply_text(text=resp, reply_to_message_id=message.id)
                                        ...
                                        await bot.delete_messages(message.chat.id, delete.id)
                                        await message.reply_text(text=e, reply_to_message_id=message.id)
